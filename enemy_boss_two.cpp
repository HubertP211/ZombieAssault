...
void enemy_boss_two::create_enemy()
{
	
	int random;
	random = rand() % 4;
	enemy_texture.loadFromFile("enemy_boss_two.png");
    ...
    enemy_move2.loadFromFile("enemy_boss_two_move2.png");
    enemy_move3.loadFromFile("enemy_boss_two_move3.png");
    enemy_move4.loadFromFile("enemy_boss_two_move4.png");
    enemy_move5.loadFromFile("enemy_boss_two_move5.png");
...
void enemy_boss_two::enemy_movement(int &frame, sf::RenderWindow &okno, float posx, float posy)
{
	//enemy_speed = 1.2;
...
void enemy_boss_two::spawn_enemy(enemy main_enemy[])
{
	for(int i = 0; i<10; i++)
	{
...
void enemy_boss_two::draw_enemy(sf::RenderWindow &okno, enemy main_enemy[], float posx, float posy, int &frame)
{
	for(int i = 0; i<10; i++)
	{
